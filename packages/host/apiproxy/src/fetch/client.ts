...
import {
  ...
  hostListDirectoryValueSchema, hostListFilesValueSchema, hostListLevelValueSchema,
...
import {
  ...
  sessionOpenDirectoryValueSchema,
...
export interface IApiClient {
  sessions: {
    ...
    openDirectory(payload: RequestPayload<'session.openDirectory'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.openDirectory'>>>
  ...
  host: {
    ...
    listLevel(payload: RequestPayload<'host.listLevel'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'host.listLevel'>>>
  }
  workspace: {
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.openDirectory': sessionOpenDirectoryValueSchema,
  ...
  'host.listLevel': hostListLevelValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    openDirectory: (payload, signal) => this.callUnary('session.openDirectory', payload, signal),
  ...
  readonly host: IApiClient['host'] = {
    ...
    listLevel: (payload, signal) => this.callUnary('host.listLevel', payload, signal),
  }
