...
export class FakeApiClient implements IApiClient {
  ...
  onOpenDirectory: (payload: unknown) => Promise<RpcResponse<{ opened: true } | { opened: false; path: string | null }>> =
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    openDirectory: (payload: unknown) =>
      this.record('session.openDirectory', payload, this.onOpenDirectory(payload)),
  ...
  readonly host: IApiClient['host'] = {
    ...
    listLevel: payload => this.record('host.listLevel', payload, this.onListLevel(payload)),
  }
