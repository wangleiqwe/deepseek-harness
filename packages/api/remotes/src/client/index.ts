...
import opencodeUsageRemote from '@deepseek-ai/dsh-opencode-go-usage/remote'
...
export type {} from '@deepseek-ai/dsh-opencode-go-usage/remote'
...
export type {
  ...
  CredentialView, DirectoryListing, DiscoveredModelView, FileEntry, FileListing, FileRef,
  HistoryEntry, HostFrame, IApiClient, LevelListing, MessageId,
