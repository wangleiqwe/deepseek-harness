...
Read a PNG/JPEG/WebP/GIF file and return the image itself. When the current model cannot accept image input, returns a text description generated through the configured image recognition vision route.
